...
@ControllerAdvice
public class AnaliseEspecieApiExceptionHandler {

    @ExceptionHandler(AnaliseEspecieApiException.class)
    protected ResponseEntity<Object> handleEntity(AnaliseEspecieApiException ex) {
