...
@ControllerAdvice
public class DepositoApiExceptionHandler {

    @ExceptionHandler(DepositoApiException.class)
    protected ResponseEntity<Object> handleEntity(DepositoApiException ex) {
